    ...
    <div className="grid gap-4">
      ...
      <Card>
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
          <Stat label="Round" value={`${d.data.meta.currentRound + (d.data.meta.lifecycle === "complete" ? 0 : 1)}/${d.data.meta.nRounds}`} sub={({ open: "Submissions open", locked: "Locked", resolving: "Resolving", published: "Resolved", complete: "Complete" } as Record<string, string>)[d.data.meta.lifecycle] ?? d.data.meta.lifecycle} accent="copper" />
