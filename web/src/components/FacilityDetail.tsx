        ...
        <div className="grid gap-4 px-5 py-4">
          ...
          <div className="grid grid-cols-2 gap-3 text-[0.82rem]">
            <div className="rounded-md border border-line bg-paper2/30 p-3">
              ...
              <div className="tnum mt-0.5 text-lg font-semibold text-ink">{online && active ? `+${fmt.int(liveCap)}` : "—"}<span className="text-[0.7rem] font-normal text-inksoft"> drinks/rd</span></div>
